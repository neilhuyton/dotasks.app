// __tests__/hooks/task/useTaskReorder.test.tsx
...
describe('useTaskReorder', () => {
  ...
  it('optimistically reorders tasks respecting isCurrent and sets pendingReorder', async () => {
  ...
  it.skip('invalidates correct queries on settled', async () => {
    ...
    server.use(
      trpcMsw.task.reorder.mutation(async () => new Promise(resolve => {
