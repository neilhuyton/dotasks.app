// __tests__/hooks/task/useTaskToggle.test.tsx
...
describe('useTaskToggle', () => {
  ...
  it('optimistically toggles isCompleted and clears isCurrent, adds to pendingToggleIds', async () => {
  ...
  it('sets toggleTaskPending correctly during mutation', async () => {
    ...
    server.use(
      trpcMsw.task.toggle.mutation(() =>
        new Promise(resolve => {
          mutationResolve = () => resolve({ ...initialTasks[0], isCompleted: true })
        })
      )
    )
