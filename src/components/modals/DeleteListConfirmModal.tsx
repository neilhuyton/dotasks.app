      ...
      >
        <div className="flex h-full flex-col items-center justify-center px-6 text-center">
          ...
          <DialogHeader className="space-y-4 mb-10">
            <DialogTitle className="text-3xl font-bold">Delete List?</DialogTitle>

            <VisuallyHidden.Root>
              <DialogDescription>
                Confirmation dialog to delete the selected list. This action is permanent and will disassociate all tasks from this list.
              </DialogDescription>
            </VisuallyHidden.Root>
